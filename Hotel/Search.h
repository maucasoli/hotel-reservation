...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnSend->Text = L"Rechercher";
			this->btnSend->UseVisualStyleBackColor = false;
			this->btnSend->Click += gcnew System::EventHandler(this, &Search::btnSend_Click);
			// 
			// btnReturn
			// 
			...
			this->btnReturn->Click += gcnew System::EventHandler(this, &Search::btnReturn_Click);
			// 
			// panel1
			// 
...
#pragma endregion
	...
	private: System::Void btnSend_Click(System::Object^ sender, System::EventArgs^ e) {
		searchReservation(comboBox, txtNom, txtPrenom, richTextBox1);
	}
		   // Button: Return
