...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnReturn->Click += gcnew System::EventHandler(this, &Create::btnReturn_Click);
			// 
			// btnSend
			// 
			...
			this->btnSend->Text = L"Réserver";
			this->btnSend->UseVisualStyleBackColor = false;
			this->btnSend->Click += gcnew System::EventHandler(this, &Create::btnSend_Click);
			// 
			// comboBox
			// 
...
#pragma endregion
	...
	private: System::Void btnSend_Click(System::Object^ sender, System::EventArgs^ e) {
		createReservation(comboBox, txtNom, txtPrenom);
	}
		   //  Button: Return
	private: System::Void btnReturn_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Close();
		   ...
		   bool dragging;
		   Point offset;
	private: System::Void Create_MouseDown(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		dragging = true;
		offset.X = e->X;
		offset.Y = e->Y;
	}
	private: System::Void Create_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		if (dragging) {
			Point currentScreenPosition = PointToScreen(Point(e->X, e->Y));
			Location = Point(currentScreenPosition.X - offset.X, currentScreenPosition.Y - offset.Y);
		}
	}
	private: System::Void Create_MouseUp(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		dragging = false;
	}
