...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnSend->Text = L"Supprimer";
			this->btnSend->UseVisualStyleBackColor = false;
			this->btnSend->Click += gcnew System::EventHandler(this, &Delete::btnSend_Click);
			// 
			// btnReturn
			// 
			...
			this->btnReturn->Click += gcnew System::EventHandler(this, &Delete::btnReturn_Click);
			// 
			// panel1
			// 
...
#pragma endregion
		...
		// Button: Annuler reservation
	private: System::Void btnSend_Click(System::Object^ sender, System::EventArgs^ e) {
		deleteReservation(comboBox, txtNom, txtPrenom);
		//this->Close();
	}
		   // Button: Return
